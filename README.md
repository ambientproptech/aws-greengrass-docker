...
1. During image build, `scripts/ggl-bake-systemd-enables.sh` creates enable symlinks for the core Greengrass Lite units without requiring a running systemd daemon.
